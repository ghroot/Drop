	...
	public class Persister
	{
		...
		public function persist() : void
		{
			...
			for (var typeNode : TypeNode = typeNodeList.head; typeNode; typeNode = typeNode.next)
			{
				...
				if (gameStateComponent != null)
				{
					...
					object["GameStateComponent"] = { "credits": gameStateComponent.credits, "matchPatternPoints": matchPatternPointsObject };
				}
		...
		public function restore() : void
		{
			...
			for each (var object : Object in objects)
			{
				...
				{
					case "game":
						engine.addEntity(entityManager.createGame(object["GameStateComponent"]["credits"], object["GameStateComponent"]["matchPatternPoints"]));
						break;
					case "tile":
